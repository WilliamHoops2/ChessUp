...
struct DifficultySelectionView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                Text("WHAT'S YOUR LEVEL OF DIFFICULTY ?")
                    .font(
                        .system(
                            size: 40,
                            weight: .black,
                ...
                VStack(spacing: 16) { // CHANGED: 10 → 16
                    difficultyRow(.easy)
                    difficultyRow(.medium)
                    difficultyRow(.hard)
                }
                .frame(maxWidth: .infinity) // CHANGED: keeps group centered
    ...
    private func difficultyDots(
        _ level: BotDifficulty,
        isSelected: Bool
    ) -> some View {
        let filled: Int
